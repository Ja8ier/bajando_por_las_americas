...
--[[     table.insert(collisions, wheel)
    ...
    phoneBoothTrigger.id = "stage2_phoneBoothTrigger"
...
function stage2.mousepressed(x, y, button)
    if isMiniGamePlaying then
