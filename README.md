...
<div style="display: flex; gap: 20px;">
  <div style="flex: 1; border-right: 2px solid #333; padding-right: 20px;">
    ...
    <ol>
      <li>Ingresar a la página de LOVE2D y descargar el archivo .ZIP o instalador según tu sistema operativo: <a href="https://www.love2d.org/">https://www.love2d.org/</a></li>
      <li>Si descargaste el .ZIP: extraerlo y mover la carpeta a la ruta que prefieras.<br>
